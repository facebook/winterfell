...
/// degree *d*. FRI proofs cannot be instantiated directly - they must be generated by a
/// [FRI Prover](crate::prover::FriProver). To verify a proof, FRI verifier's
/// [verify()](crate::verifier::verify()) function should be used.
///
