...
impl MockAir {
    pub fn with_periodic_columns(
        ...
        let mut result = Self::new(
            ...
            (),
            ProofOptions::new(32, 8, 0, FieldExtension::None, 4, 31, BatchingOptions::Linear),
        );
...
pub fn build_context<B: StarkField>(
    ...
    let options = ProofOptions::new(32, 8, 0, FieldExtension::None, 4, 31, BatchingOptions::Linear);
