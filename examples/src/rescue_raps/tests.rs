...
fn rescue_test_basic_proof_verification() {
    let rescue_eg =
        Box::new(super::RescueRapsExample::<Blake3_256>::new(128, build_options(false)));
    crate::tests::test_basic_proof_verification(rescue_eg);
}

#[test]
fn rescue_test_basic_proof_verification_extension() {
    let rescue_eg = Box::new(super::RescueRapsExample::<Blake3_256>::new(128, build_options(true)));
    crate::tests::test_basic_proof_verification(rescue_eg);
}
...
fn build_options(use_extension_field: bool) -> ProofOptions {
    ...
    ProofOptions::new(28, 8, 0, extension, 4, 31, BatchingMethod::Horner, BatchingMethod::Horner)
}
