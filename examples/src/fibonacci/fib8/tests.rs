...
fn fib8_test_basic_proof_verification() {
    let fib = Box::new(super::Fib8Example::<Blake3_256>::new(64, build_proof_options(false)));
    crate::tests::test_basic_proof_verification(fib);
}

#[test]
fn fib8_test_basic_proof_verification_extension() {
    let fib = Box::new(super::Fib8Example::<Blake3_256>::new(64, build_proof_options(true)));
    crate::tests::test_basic_proof_verification(fib);
}
