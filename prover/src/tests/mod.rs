...
use air::{
    Air, AirContext, Assertion, BatchingType, EvaluationFrame, FieldExtension, ProofOptions,
...
impl MockAir {
    pub fn with_trace_length(trace_length: usize) -> Self {
        Self::new(
            ...
            (),
            ProofOptions::new(32, 8, 0, FieldExtension::None, 4, 31, BatchingType::Linear),
        )
    }
...
fn build_context<B: StarkField>(
    ...
    let options =
        ProofOptions::new(32, blowup_factor, 0, FieldExtension::None, 4, 31, BatchingType::Linear);
