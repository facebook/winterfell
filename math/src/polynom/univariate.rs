...
#[derive(Clone, Debug)]
pub struct CompressedUnivariatePolyCoef<E: FieldElement>(Vec<E>);

impl<E: FieldElement> CompressedUnivariatePolyCoef<E> {
...
impl<E: FieldElement> Serializable for CompressedUnivariatePolyCoef<E> {
    fn write_into<W: ByteWriter>(&self, target: &mut W) {
        self.0.write_into(target);
    }
}

impl<E> Deserializable for CompressedUnivariatePolyCoef<E>
where
    E: FieldElement,
{
...
impl<E: FieldElement> CompressedUnivariatePolyEvals<E> {
    ...
    pub fn to_poly(&self, round_claim: E) -> CompressedUnivariatePolyCoef<E> {
        ...
        CompressedUnivariatePolyCoef(coefficients)
    }
}
